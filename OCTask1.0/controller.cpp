...
void
controller::save_agent_report(const unsigned long expNo, const unsigned long problem_no) const
{
	ofstream	output;			//!
...
void
controller::save_agent_state(const unsigned long expNo, const unsigned long problem_no) const
{
	ofstream	output;			//!
	char		fileName[MSGSTR];	//!
	char		sysCall[MSGSTR];	//! string for system call
...
void
controller::save_state(const unsigned long expNo, const bool flag_exploration, unsigned long problem_no) const
{
	ofstream	outfile;
	char	fileName[MSGSTR];
...
bool
controller::restore_state(const unsigned long expNo)
{
