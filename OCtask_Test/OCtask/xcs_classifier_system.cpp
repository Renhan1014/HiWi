...
//! build [M]
unsigned long	
xcs_classifier_system::match(const binary_inputs& detectors)
{
...
bool
xcs_classifier_system::perform_covering(t_classifier_set &match_set, const binary_inputs& detectors)
{
...
bool
xcs_classifier_system::perform_standard_covering(t_classifier_set &match_set, const binary_inputs& detectors)
{
...
bool
xcs_classifier_system::need_standard_covering(t_classifier_set &match_set, const binary_inputs& detectors)
{
	//unsigned long	i;
	t_set_iterator	pp;					//! iterator for visiting [P]
	//unsigned long	sz = 0;					//! number of micro classifiers in [M]
...
xcs_classifier_system::step(const bool exploration_mode, const bool condensationMode)
{
	...
	task_env* Environment = task->getEnvironment();
...
bool	
xcs_classifier_system::perform_nma_covering(t_classifier_set &match_set, const binary_inputs& detectors)
{
	vector<t_system_prediction>::iterator	pr;
	binary_action		act;
 ...
 */
void	
xcs_classifier_system::build_action_set(const binary_action& action)
{
	//! iterator in [M]
	t_set_iterator 	mp;
...
xcs_classifier_system::init_population_random()
{
	...
	{
		xcs_classifier *classifier = new t_classifier();
		classifier->random();
		init_classifier(*classifier);
		insert_classifier(*classifier);
	}
